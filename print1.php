...
<head>
    ...
    <link rel="icon" href="assets/img/receipt.png" />
...
<a href="home.php" type="button" class="btn btn-primary btn-lg"><i class="fa fa-home" aria-hidden="true"></i> Go Back Home</a>
<hr>

...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="assets/img/attendant.png" />
    <!-- Bootstrap core CSS -->
	  ...
	  <div id="login-page">
	  	<div class="container">
		      ...
		      <form class="form-login" action="attendant_login.php" method="post">
		        <h2 class="form-login-heading">Attendant Login</h2>
		        <div class="login-wrap">
		            ...
		            <button class="btn btn-theme btn-block" href="index.php" name='attendant_login'  type="submit"><i class="fa fa-lock"></i> Login</button>
		          <!-- Modal -->
...
if(mysqli_num_rows($result) > 0)
{
  ...
  while($row = mysqli_fetch_array($result))
  {
    ...
    {
      //return false
       echo"<script>alert('Wrong user details, please try again!')</script>";
